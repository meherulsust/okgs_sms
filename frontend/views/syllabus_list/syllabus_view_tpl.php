<link rel="stylesheet" href="<?=$js_url;?>pdfviewer/css/viewer.css"/>
<script type="text/javascript" src="<?=$js_url;?>pdfviewer/js/compatibility.js"></script>
<link rel="resource" type="application/l10n" href="locale/locale.properties"/>
<script type="text/javascript" src="<?=$js_url;?>pdfviewer/js/l10n.js"></script>
<script type="text/javascript" src="<?=$js_url;?>pdfviewer/build/pdf.js"></script>
<script type="text/javascript" src="<?=$js_url;?>pdfviewer/js/debugger.js"></script>
<script type="text/javascript" src="<?=$js_url;?>pdfviewer/js/viewer.js"></script>
  <body tabindex="1">
	<div align='center'> 
...
var DEFAULT_URL = '<?php echo $admin_url.'/uploads/upload_syllabus_image/'.$file_name;?>';
...
PDFJS.imageResourcesPath = '<?=$js_url;?>pdfviewer/images/';
  PDFJS.workerSrc = '<?=$js_url;?>pdfviewer/build/pdf.worker.js';
  PDFJS.cMapUrl = '<?=$js_url;?>pdfviewer/cmaps/';
