...
<table style="width:100%;">
    ...
    <table style="width:100%;">
        <tr>
            <td width="10%">Name : </td>
            <td width="60%"><?php  echo $results['student_name']; ?></td>
            <td width="10%">Form : </td>
            <td width="20%"><?php echo $results['section_title']; ?></td>
        </tr>
        <tr>
            <td>Roll : </td>            
		 ...
		 <tr>
            ...
            <!--<td><?php if($results['class_id'] == 6 || $results['class_id'] == 8){echo '';}else{ ?>House <?php }?></td>
            <td><?php if($results['class_id'] == 6 || $results['class_id'] == 8){echo '';}else{ ?>: <?php echo $results['house']; ?></td><?php }?>-->
        </tr>
    </table>
    <?php
        $nurserykg = 0;
        $onetwo = 0;
        if($results['class_id'] == 6 || $results['class_id'] == 8){$nurserykg = 2;}
        if($results['class_id'] == 1 || $results['class_id'] == 2){$onetwo = 2;}
    ?>

    <table class="main_table" border="1">
        <tr>
		<th <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?> style="color: #000000;">Subject</th>
                <th style="color: #000000;" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?> <?php if($results['class_id'] < 32){?>style="width: 15%" <?php } ?>> <?php if($results['class_id'] < 32){?> Full Marks <?php }else{ ?> Marks <?php } ?> </th>
			<?php 
			if($ct > 0){ 
				if($ct >= 2){ 
			?>
			...
			?>
            <th style="color: #000000;" width="85" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>> <?php if($results['class_id'] < 32){?> Obtain Marks<?php }else{ ?> Grand Total<br /> <?php } ?> </th>
            <th style="color: #000000;" width="85" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>>Grade Point</th>
            <th style="color: #000000;" width="85" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>>Letter Grade</th>
            <th style="color: #000000;" width="130" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>>Class Highest</th>
            <th style="color: #000000;" width="85" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>>Result Status</th>
            <th style="color: #000000;" width="65" <?php if($results['class_id'] > 31){?>rowspan="2"<?php } ?>>Position</th>
        </tr>
        <tr>            
            ...
            <?php if($results['class_id'] > 31){?><th style="color: #000000;">Term Exam</th><?php } ?>
            <?php }else{ ?>
        ...
        <tr>
            ...
            <!--<td align="center"></td>-->
            <?php // } ?>
            <?php if(!empty($results['total_mks']['total_mks_half_yearly'])): ?><td style="color:blue" align="center"> <b><?php echo $results['total_mks']['total_mks_half_yearly'];  ?></b></td> <?php endif; ?>
