...
<head>
	...
	<link rel="shortcut icon" type="image" href="<?php echo base_url().'smsadmin/uploads/logo/'.$logo_file;?>"/>
			...
			<div class="contentleft">
				...
				<div id="profile_menu">
					<ul>
						...
						<li class="icon_list"><a href="<?php echo site_url('attendance'); ?>">View Attendance</a></li>
						<li class="icon_list"><a href="<?php echo site_url('payment'); ?>">Payment List</a></li>
						...
						<li class="icon_new"><a href="<?php echo site_url('result'); ?>">Result</a></li>
						<!--<li class="icon_list"><a href="<?php echo site_url('comment'); ?>">Comment Here</a></li>-->
						<li class="icon_list"><a href="<?php echo site_url('home/prospectus'); ?>">Prospectus</a></li>
						<li class="icon_login"><a href="<?php echo site_url('home/change_password'); ?>">Change Password</a></li>
					</ul>
				</div>						
				

				  <?php echo student_image($student_number)?>
