...
class Stuffmodel extends BACKEND_Model {
...
public function __construct() {
    ...
    public function get_columns() {
        return array('id','name','dob','designation_id','gender','blood_group_id','religion_id','address','mobile_no','email','t.status','photo','relevant_subject_id','created_at','updated_at','created_by','updated_by','order','edulabel');
    }
	
    public function grid_query() {
        $this->db->select('t.id,t.name as full_name,gender,mobile_no,email,address,dob,t.status,t.order,t.edulabel,sub.title relevant_subject,blg.title blood_group,r.title religion,dg.title as designation',False)
                ->from('teacher t')
				...
				->where_not_in('designation_id',array('2','3','14','17','18','50','51','52','53','54'))
