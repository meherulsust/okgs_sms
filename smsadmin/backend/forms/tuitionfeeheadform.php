...
class Tuitionfeeheadform extends MT_Form{
	...
	public function init()
	{
		...
		$this->add_select('head_type',array('COST'=>'Cost','WAIVER'=>'Waiver','CONDITIONAL'=>'Conditional','TRANSPORT'=>'Transport Facility','SPECIAL_CLASS'=>'Special Class','FINE'=>'Fine','RESIDENTIAL'=>'Residential'),array('style'=>'width:100px;'))->set_default('0')->set_validator('required')->set_label('Head Type');
