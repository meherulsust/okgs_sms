 ...
 * class guardian form
 */
class Motherform extends MT_Form {

    public function init() {
        $this->set_name('mother');
        $this->add_hidden('id');
        ...
        $this->add_model_select('occupation_id', array('model' => 'occupationmodel'))->set_default('10')->set_label('Occupation');
        ...
        $this->add_input('national_id', array('class' => 'txt'))->set_label('National ID Number');
        $this->add_input('mobile')->set_label('Mobile');
        $this->add_hidden('student_id', '');
        $this->add_hidden('relationship_id', 1);
