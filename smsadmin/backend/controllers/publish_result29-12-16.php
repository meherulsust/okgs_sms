...
//        $total_student_no = $this->publish_resultmodel->get_student_no($class_id);
        ...
        $topper = $this->publish_resultmodel->get_top_student($class_id, $exam_id);
        $top_score = ($topper['half_yearly'] + $topper['yearly'])/2;
...
//            arsort($asd);
    ...
    function calculate_pass_fail($class, $subject, $creative = "", $mcq = "", $practical = "") {
        if ($class == '32'OR $class == '36') {
            $sub_60 = array(63, 56, 57, 75, 59, 68);
            $sub_50 = array(64, 67);
            $sub_80 = array(65);
            $sub_25 = array(71,69,70,72);
           // $sub_10 = array(70, 72);
        ...
        elseif ($class == '39' OR $class == '41') {
            $sub_60 = array(63, 64, 56, 57, 75, 59, 86, 84, 96);
            $sub_25 = array(111, 69);
            $sub_40 = array(71, 102, 112, 93, 108, 109, 102);
            $sub_100 = array(65, 67);
			...
			elseif (in_array($subject, $sub_40)) {
                if (!empty($creative)) {
                    $rs = $creative < 13 ? "F" : "P";
                }
                if (!empty($mcq)) {
