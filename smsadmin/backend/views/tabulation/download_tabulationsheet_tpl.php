<?php
    ...
    header("Expires: 0");	
?>
            <h3 id="add">Tabulation Sheets</h3>
...
//                print_r($results);
            ...
            <?php 
                $tofive = 0;
                if(isset($class_details['class_id']) && $class_details['class_id'] < 32){ $tofive = 1; }
            ?>
            <table border="1" width="100%">
                <tr>
                    ...
                    ?>
                    <th colspan="<?php echo count($course['exam_types']) + 2 - $tofive; ?>">
                ...
                <tr>
                    ...
                    ?>
                    <?php if(isset($class_details['class_id']) && $class_details['class_id'] > 31){  ?>
                ...
                <tr>
                    ...
                    <td style="<?php if(isset($color)){ echo $color;}else{echo '';} ?>" align="center">
                        <?php if(!empty($result)){ echo $result['scale_matrix']['title'].'<br />' ?>
                        <?php 
                        if($result['scale_matrix']['weight'] > 5){
                            echo '5.00';
                        }else{
                            echo sprintf('%.2f',$result['scale_matrix']['weight']);
                        }
                        }else {echo '';} ?>
                    </td>
