            ...
            <div class="contentbox">
            	<form action="#">
                    ...
                    <p>
                        ...
                        <input type="text" id="errorbox" class="inputbox errorbox" /> <img SRC="<?php echo $image_url ?>icons/icon_missing.png" alt="Error" /> <br />
                    ...
                    <p>
                        ...
                        <input type="text" id="correctbox" class="inputbox correctbox" /> <img SRC="<?php echo $image_url ?>icons/icon_approve.png" alt="Approve" />
                    </p>
                    <p>
                    ...
                    <input type="file" id="uploader" /> <img SRC="<?php echo $image_url ?>loading.gif" alt="Loading" /> Uploading...
