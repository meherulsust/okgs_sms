            ...
            <table>
                <tr>
                    <td align="center">
						...
						<a style="float: right;margin: 0 10px 0;background: whitesmoke;margin-top: 0px;padding: 6px 0px;" href="<?php echo site_url('report'.'/download_student_info')?>" class="btn btn-primay">Download</a>
					</td>
                </tr>
            </table>
        </div>
