...
<form name='frm-config-exam-classes' id='frm-config-exam-classes' method='post' action='<?php echo site_url($active_module.'/update_result')?>' >
        <?php 
//        echo '<pre>';
//        print_r($form_elements);
            if(!empty($form_elements) && !empty($form_elements[0]['result_sheet_id'])):
                 $x= 0;
        ?>
        <table>        
        <tr>
            <td style="text-align: center; font-size: 14px;"><b>Class:</b></td>
            <td width="40%" style="font-size: 14px;"><?php echo $entry_details['class_title']; ?></td>
        </tr>
        <tr>
    ...
    <table width='100%' class="result_entry_table">
        ...
        ?>
        <tr>
            <!--<td colspan="<?php echo $col = sizeof($form_element['form_fields'])*2; ?>"><b><?php echo $form_element['student_name'];  ?></b></td>-->
        <td colspan="<?php echo $col = sizeof($form_element['form_fields'])*2; ?>">
        ...
        <tr>
        <?php foreach ($form_element['form_fields'] as $key=>$element):  ?>
            
            <td><?php echo $element;  ?></td>
            <td>
                <input class="result_sheet_input" name="<?php echo $key; ?><?php echo $x; ?>" id="<?php echo $key; ?><?php echo $x; ?>" value="<?php echo $form_element[$key];   ?>" />
            <!--<input class="result_sheet_input" name="<?php echo $key; ?><?php echo $x; ?>" id="<?php echo $key; ?><?php echo $x; ?>" placeholder="<?php echo $element;  ?>" value="<?php echo $form_element[$key]; ?>" />-->
            </td>
        ...
        <input type="hidden" name="result_sheet_id<?php echo $x; ?>" id="result_sheet_id<?php echo $x; ?>" value="<?php echo $form_element['result_sheet_id']; ?>" />
