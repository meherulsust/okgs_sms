...
<?php 
	...
	<tr>
		...
		<td align="center" width="46%">
                    ...
                    <div class="school_header_info school_name">Progress Report : <?php echo $exams[0]['title']; ?></div>
		</td>
		...
		<th rowspan="2">Marks</th>
			...
			<?php }else{ ?>
				<th colspan="<?php echo $subjective; ?>">Term Total</th>
                        <?php } } }  ?>
            <th width="85" rowspan="2">Grand Total<br /></th>
...
<!--            <td align="center">50%</td>-->
        ...
        <?php 
            //if(!empty($res['position'])){
                ...
                if($j == 0){
        ?>
            <td align="center" rowspan="<?php echo count($res['results']) + $add_drawing; ?>"> <?php echo $result['position']; ?></td>  
        <?php }
		//} ?>
        </tr>		
        <?php  
        ...
        <tr>
            ...
            <?php if(!empty($subjects['creative']) AND !empty($subjects['mcq'])){  ?>
            <?php if($res['class_id'] > 31){ ?><td align="center"></td>
            <?php }} ?>
        ...
        <tr>
            ...
            <td align="center"></td>
            <?php } ?>
            <?php if(!empty($res['total_mks']['total_mks_half_yearly'])): ?><td style="color:blue" align="center"> <b><?php echo $res['total_mks']['total_mks_half_yearly'];  ?></b></td> <?php endif; ?>
