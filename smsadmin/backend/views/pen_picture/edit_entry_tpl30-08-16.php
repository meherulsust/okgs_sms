        ...
        <tr>
            ...
            <td>
                <select class="activity_select_input" name="pen_picture_temaplte_id<?php echo $x; ?>" id="pen_picture_temaplte_id<?php echo $x; ?>">
                    ...
                    ?>
                    <option <?php if($template['id'] == $form_element['pen_picture_temaplte_id']){echo 'selected="selected"';}else{echo '';} ?>value="<?php echo $template['id']; ?>"><?php echo $template['title']; ?></option>
                    <?php } ?>
                </select>
            </td>
