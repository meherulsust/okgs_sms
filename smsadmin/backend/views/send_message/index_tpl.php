...
<div class="box">
    ...
    <tr>
		<td><strong>Purchased Total SMS :&nbsp;<span><?php echo $result['total_purchage_sms'];?></span></strong></td><td><strong>SMS Send :&nbsp;<span style='color:red'><?php echo $result['total_sent_sms'];?></span></strong></td><td><strong>Available SMS :&nbsp;<span style='color:green'><?php echo $asd = $result['total_purchage_sms'] - $result['total_sent_sms'];?></span></strong></td>
	</tr>
