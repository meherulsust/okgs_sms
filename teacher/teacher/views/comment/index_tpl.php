...
<h1>Write Your comment about School</h1>
...
<table width="80%" align="center" class="list_table">
	<tr>
		...
		<th width="35%" align="center"><b>Reply</b></th>	
		<!--<th width="10%" align="center"><b>Reply Date</b></th>-->	
	</tr>
	<?php if($all_comment): ?>
	<?php 
	$i=1;
	...
	<tr>
		...
		<td><?php echo $note['reply']; ?></td>	
		<!--<td><?php echo $note['reply_date']; ?></td>-->	
	</tr>
    <?php 
	$i++;
	endforeach; 
