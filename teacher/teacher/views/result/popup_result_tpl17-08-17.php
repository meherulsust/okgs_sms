...
<table style="width:100%;">
    ...
    <table class="main_table">
        <tr>
		<th <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Subject</th>
                <th <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?> <?php if($results[0]['class_id'] < 32){?>style="width: 15%" <?php } ?>> <?php if($results[0]['class_id'] < 32){?> Full Marks <?php }else{ ?> Marks <?php } ?> </th>
			<?php 
			if($ct > 0){ 
				if($ct >= 2){ 
			?>
			...
			?>
            <th width="85" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>> <?php if($results[0]['class_id'] < 32){?> Obtain Marks<?php }else{ ?> Grand Total<br /> <?php } ?> </th>
            <th width="85" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Grade Point</th>
            <th width="85" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Letter Grade</th>
            <th width="130" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Class Highest</th>
            <th width="85" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Result Status</th>
            <th width="65" <?php if($results[0]['class_id'] > 31){?>rowspan="2"<?php } ?>>Position</th>
        </tr>
        <tr>            
            ...
            <?php if($results[0]['class_id'] > 31){?><th>Term Exam</th><?php } ?>
            <?php }else{ ?>
